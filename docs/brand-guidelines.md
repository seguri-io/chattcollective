...
Status: **draft** — informed by the Claude Design handoff (see `docs/handoff/`) and the working session that adjudicated it. Edit freely; this document is the source of truth, so changes here drive site copy and `docs/design-system.md`.
...
Primary: **Chattanooga locals** who want real food from real people and would rather buy from a neighbor than a chain. Often shop at farmers markets, follow local makers on Instagram, care where their food comes from.

Secondary:
- New Chattanooga residents looking for the local food scene
- Wedding / event planners sourcing small-batch goods
- Other regional cottage food makers who might want to join

Not the audience: out-of-state shoppers (TN cottage food law generally restricts interstate sales), wholesale buyers, restaurants. Don't write copy for them.
...
- **Appalachian framing.** The name comes from the Ridge and Valley Appalachians — the topographic province that runs through Chattanooga. Lean into that:
  - Foraged / mountain-sourced where applicable (lion's mane, reishi, ramps, sumac, sassafras root if it's in product)
  - Acknowledge the cultural lineage of Appalachian foodways alongside ayurvedic and East Asian functional traditions — the brand sits at the intersection
  - Words to consider: *foothills, hollow, holler, ridgeline, mountain, ridge-grown, valley-foraged*
  - Words to avoid: anything that smells like marketing-cabin-aesthetic ("authentic mountain heritage," "hand-foraged with love")
- Ayurvedic / sea vegetable ingredients shouldn't be exoticized. Name them plainly (turmeric, kombu, ashwagandha) — explain what they do in one line, move on.
...
Every Collective page should reinforce some combination of these:
...
The opposite of stock food photography.

**Yes**
- Daylight, ideally near a window
- Hands in frame — kneading, slicing, holding, bottling
- Imperfect crusts, dusted counters, real kitchens
- Wide-ish crops that show context (the kitchen, the bag, the porch handoff)
- For Ridge & Valley: the actual landscape — ridges, valleys, foraging context — is fair game alongside kitchen shots
- Color: warm, slightly desaturated, no Instagram filters

**No**
- Overhead "flat lay" with props
- Glossy reflections, studio lighting
